...
namespace PR28
{
    public partial class ManagerForm : Form
    {
        ...
        public ManagerForm(string info, int id)
        {
            InitializeComponent();
            managerInfo = info;
            managerID = id;
        ...
        {
            OrderManager orderForm = new OrderManager(managerInfo);
            this.Visible = false;
        ...
        {
            CurrentManagerOrder currentOrderForm = new CurrentManagerOrder(this);
        ...
        private void AddSelectedProductToOrder(int rowIndex)
        {
            ...
            var existingItem = ManagerForm.CurrentOrder.Items.FirstOrDefault(i => i.ProductArticleNumber == article);
            ...
            else
            {
                ...
                ManagerForm.CurrentOrder.Items.Add(new ManagerForm.OrderItem
                {
