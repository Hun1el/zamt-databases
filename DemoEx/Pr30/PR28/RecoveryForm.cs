        ...
        private void button2_Click(object sender, EventArgs e)
        {
            ...
            if (ofd.ShowDialog() == DialogResult.OK)
            {
                try
                {
                    ...
                    using (MySqlConnection conn = new MySqlConnection(DbConnectNoDb.GetNoDb()))
                    {
                        conn.Open();
                    ...
                    MessageBox.Show("Структура базы успешно восстановлена без данных!", "Успех", MessageBoxButtons.OK, MessageBoxIcon.Information);
                }
                catch (Exception ex)
                {
